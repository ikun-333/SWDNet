...
class TrainOptions():
  def __init__(self):
    ...
    self.parser.add_argument('--n_ep', type=int, default=3000, help='number of epochs')
    ...
    self.parser.add_argument('--warmup_steps', type=int, default=200, help='warmup steps for learning rate scheduler')
    self.parser.add_argument('--warmup_start_lr', type=float, default=1e-4, help='learning rate used at warmup start')
...
class TestOptions():
  def __init__(self):
    ...
    ## mode related
    self.parser.add_argument('--class_nb', type=int, default=9, help='class number for segmentation model')
    self.parser.add_argument('--resume', type=str, default='./results/SDCFusion/fusion.pth', help='specified the dir of saved models for resume the training')
    self.parser.add_argument('--gpu', type=int, default=0, help='GPU id')
    
    # results related
    self.parser.add_argument('--name', type=str, default='SDCFusion', help='folder name to save outputs')
    self.parser.add_argument('--result_dir', type=str, default='Fused_image_MSRS' + '/', help='path for saving result images and models')
